    ...
    <Section id="chambres" className="bg-muted/30">
      ...
      {activeRoom && (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
          ...
          />
          <div
            className="relative w-full max-w-3xl bg-background rounded-3xl overflow-hidden shadow-2xl max-h-[90vh] flex flex-col transition-all duration-300 scale-100 opacity-100"
          >
            <button 
              onClick={() => setActiveRoom(null)}
